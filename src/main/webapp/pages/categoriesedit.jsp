  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
         		<form:form modelAttribute="category" action="edit"  method="post" id="frm-add" enctype="multipart/form-data">
			        ...
			        <div class="modal-footer">
			          <form:button type="submit" id="themmoi" class="btn btn-primary">Cập nhật</form:button>
			        </div>
		 		</form:form>
        </div>
        <!-- /.box-body -->
