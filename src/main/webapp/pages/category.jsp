		...
		<div class="site_container">
			...
			<div class="menu_container clearfix">
				...
				<ul class="sf-menu">
					...
					<li class="submenu">
						<a href="<%=request.getContextPath()%>" title="Blog">
							Blog
						</a>
						<ul>
							<li>
			...
			<div class="page">
				<div class="page_header clearfix page_margin_top">
					<div class="page_header_left">
						<h1 class="page_title">Danh mục: <c:out value="${CategoriesName.name}"></c:out></h1>
					</div>
					<div class="page_header_right">
						<ul class="bread_crumb">
							...
							<li>
								 <c:out value="${CategoriesName.name}"></c:out>
							</li>
						</ul>
					</div>
				</div>
				<div class="page_layout clearfix">
					...
					<div class="row">
						<div class="column column_2_3">
							<div class="row">
								<ul class="blog big">
									<c:forEach items="${listPostByCategory}" var="item">
										<li class="post">
										<a href="<%=request.getContextPath() %>/${item.slug}" title="${item.title}">
											<img src='<%=request.getContextPath() %>/displaythumbnail/${item.id}' alt='img'>
										</a>
										<div class="post_content">
											<h2 class="with_number">
												<a href="<%=request.getContextPath()%>/${item.slug}" title="${item.title}">${item.title}</a>
												<a class="comments_number" href="#" title="${item.viewCount} views">${item.viewCount}<span class="arrow_comments"></span></a>
											</h2>
											<ul class="post_details">
												<li class="category"><a href="#" title="${item.categoriesName}">${item.categoriesName}</a></li>
												<li class="date">
													<fmt:formatDate type = "both"  dateStyle = "short" timeStyle = "short" value = "${item.createdAt}" />
												</li>
											</ul>
											<p>${item.description}</p>
											<a class="read_more" href="<%=request.getContextPath()%>/${item.slug}" title="Read more"><span class="arrow"></span><span>READ MORE</span></a>
										</div>
									</li>
									</c:forEach>
