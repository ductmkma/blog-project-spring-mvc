    ...
    <section class="content">
      ...
      <div class="box">
       ...
       <div class="box-body container">
						<div class="row">
							<form:form modelAttribute="posts" action="edit" method="POST" enctype="multipart/form-data">
								<div class="col-md-8">
								<form:input path="id" value="${posts.id}" type="hidden" placeholder="Enter title" name="id" id="id" class="form-control input-group" title=""/>
								<form:input path="viewCount" value="${posts.viewCount}" type="hidden" placeholder="Enter title" name="viewCount" id="viewCount" class="form-control input-group" title=""/>
									<div class="col-md-12">
										<label>Tiêu đề</label>
										...
										<form:input path="title" type="text" placeholder="Enter title" name="title" id="title" class="form-control input-group" title="" value=""/>
										<form:errors path="title" cssClass="error"></form:errors>
										<br>
									</div>
									<div class="col-md-12">
										<label>Permalink</label>
										<form:input path="slug" type="text" placeholder="" readonly="true" name="slug" id="slug" class="form-control input-group" value="" title=""/>
									...
									<div class="panel-group">
										...
										<div class="panel panel-primary">
											...
											<div id="collapse3" class="panel-collapse collapse in">
												<div class="panel-body form-group">
													<form:input path="tags" type="text" name="tags" id="tags" class="input"  data-role="tagsinput" />
											...
											<div id="collapse4" class="panel-collapse collapse in">
												<div class="panel-body form-group">
													 ...
													 <form:input path="thumbnail" id="file-upload" type="file" name="thumbnail" accept="image/*" /> 
														<label for="file-upload" id="file-drag"> <img id="file-image" src="http://localhost:8080/Blog/displaythumbnail/${posts.id }" alt="Preview">
	...
	$(document).ready(function(){
		...
		$("#title").on('keyup',function(){
			var ctx = "${pageContext.request.contextPath}";
	         ...
	         if(title!=""){
	        	 $("#slug").val("http://localhost:8080/Blog/"+slug+'-'+random());
	         }else{
	        	 $("#slug").val("");
	         }
